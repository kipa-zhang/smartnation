...
public class GsonUtil {  
	...
	public static void main(String[] args) {
		...
		Map<String, String> map =  GsonUtil.jsonToMap4String(c);
...
//		person p2 = (person)gson.fromJson(jsonStr, person.class);
//		System.out.println(p2.getName());
		
		String jsStr = "{\"name\":\"kipa\",\"info\":{\"age\":18}}";
