...
public interface BaseDao<T> {
	 ...
	 * @return
	 */
	public List<T> findByPage(Class clazz, String hql, Map<String, Object> params, int page, int rows);
	/**
	 * 
	 * @param hql
	 * @param params
	 ...
	 * @return
	 */
	public List<T> find(Class clazz, String hql, Map<String, Object> params, int start, int length);
