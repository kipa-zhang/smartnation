package org.st.smartnation.basedao;
...
public interface BaseDao<T> {
	 ...
	 * @return
	 */
	public List<T> findByPage(DetachedCriteria criteria, String hql, Map<String, Object> params, int page, int rows);
	/**
	 * 
	 * @param hql
	 * @param params
	 ...
	 * @return
	 */
	public List<T> find(DetachedCriteria criteria, String hql, Map<String, Object> params, int start, int length);
